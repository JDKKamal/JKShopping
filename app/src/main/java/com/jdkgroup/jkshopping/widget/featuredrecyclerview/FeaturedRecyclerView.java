package com.jdkgroup.jkshopping.widget.featuredrecyclerview;
...
public class FeaturedRecyclerView extends RecyclerView {
    ...
    private void initAttributes(TypedArray array) {
        ...
        defaultItemHeight = (int) array.getDimension(R.styleable.FeaturedRecyclerView_defaultItemHeight, getResources().getDimension(R.dimen.defaultItemHeight));
        featuredItemHeight = (int) array.getDimension(R.styleable.FeaturedRecyclerView_featuredItemHeight, getResources().getDimension(R.dimen.featuredItemHeight));
