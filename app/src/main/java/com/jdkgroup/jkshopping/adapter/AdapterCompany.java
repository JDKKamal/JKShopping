...
public class AdapterCompany extends RecyclerView.Adapter<AdapterCompany.ViewHolder> {
    ...
    public AdapterCompany(Activity activity, List<ModelCompany> alCompany) {
        ...
        public ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    general.SwitchPassdataChangeFragment(activity, AppKeyword.REDIRECT_HOME_FASHION_PRODuct_31);
                }
            });
